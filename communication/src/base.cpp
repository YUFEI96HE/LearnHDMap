...
extern const char SERVER_IP[] = "192.168.43.100";
extern const int SERVER_PORT = 6665;
extern const int BACKLOG = 10;
...
int accept_socket(int listen_sock)
{
    ...
    //return accept(listen_sock, (struct sockaddr *)&client, &addr_size);
    return accept(listen_sock, (struct sockaddr *)NULL, NULL);
}
