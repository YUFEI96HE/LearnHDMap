...
static bool if_autoware_calibration;
...
void tfRegistration(const cv::Mat &camExMat, const ros::Time &timeStamp)
{
    ...
    //if autoware calibration result, transpose rotation matrix, adjust translation vector
    if (if_autoware_calibration)
    {
        // rotation
        ...
        //translation
        transform.setOrigin(tf::Vector3(camExMat.at<double>(1, 3),
                                        camExMat.at<double>(2, 3),
                                        -camExMat.at<double>(0, 3)));
    }
    else
    {
        rotation_mat.getRPY(roll, pitch, yaw, 1);
...
int main(int argc, char *argv[])
{
    ...
    nh_private.param<bool>("if_autoware_calibration", if_autoware_calibration, "false");
    ...
    std::cout << "calibration path: " << calibration_file << std::endl;
    ...
    std::cout << "CameraExtrinsicMat: " << calibration_file << std::endl;
    std::cout << CameraExtrinsicMat << std::endl;
